...
namespace LinkShortener.Models.Database
{
    ...
    public abstract partial class AbstractDatabase
    {
        ...
        protected AbstractDatabase()
        {
            ...
            connection = new MySqlConnection("SERVER=35.184.174.117;DATABASE=mysql;UID=" + UID + ";AUTO ENLIST=false;PASSWORD=" + Password);
            createDB();
        }
            ...
            if (openConnection() == true)
            {
                ...
                catch (MySqlException e)
                {
                    if (e.Number == 1007)//Database already exists, no need to continure further
                    {
                        ...
                        closeConnection();
                        connection = new MySqlConnection("SERVER=35.184.174.117;DATABASE=" + databaseName + ";UID=" + UID + ";AUTO ENLIST=false;PASSWORD=" + Password);
                        return;
                    }
